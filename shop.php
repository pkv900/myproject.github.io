...
<meta name="keywords" content="INDIASHOP" />
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                  ...
                  <!--  <div class="carousel-caption kb_caption">
                        ...
                        <h4 data-animation="animated flipInX">INDIASHOP</h4>
                    </div>-->
                </div>
                ...
                <div class="item">
                    ...
                    <!--<div class="carousel-caption kb_caption kb_caption_right">
                        ...
                        <h2 data-animation="animated flipInX">INDIASHOP</h2>
                    </div>-->
                </div>
	...
	<!--content-->
		<div class="content">
			...
			<div class="welcome-w3">
				<div class="container">
					<h2 class="tittle">Welcome To INDIASHOP</h2>
				</div>
			</div>
			<!--welcome-->
				...
				<div class="container">
					...
					<div class="student-grids">
						<div class="col-md-6 student-grid">
							...
							<ul class="grid-part">
								<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Ghaziabd,India</li>
								<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>8527000000</li>
								<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:india.shop@gmail.com"> india.shop@gmail.com</a></li>
							</ul>
